import{G as h,S as p,w as g}from"./sigma-D6zuMBvc.js";import{l as x}from"./index-ClgVfkyp.js";import{i as C}from"./index-BT1YDs3_.js";import{d as k}from"./data-ro0eVT-D.js";import{b as y,c as b}from"./index-6OLwy2uX.js";import{p as E}from"./index-CvkDsaGQ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./getters-Dzi6BvTr.js";import"./is-graph-constructor-C6mKuIz0.js";import"./add-edge-CCsz5v3R.js";const S=()=>{const e=new h;e.import(k),x.assign(e,{nodeCommunityAttribute:"community"});const r=new Set;e.forEachNode((n,o)=>r.add(o.community));const t=Array.from(r),l=C(r.size).reduce((n,o,c)=>({...n,[t[c]]:o}),{});e.forEachNode((n,o)=>e.setNodeAttribute(n,"color",l[o.community]));const u=document.getElementById("sigma-container"),s=new p(e,u),a=document.createElement("div");return a.style.position="absolute",a.style.right="10px",a.style.bottom="10px",document.body.append(a),t.forEach((n,o)=>{const c=`cb-${n}`,i=document.createElement("div");i.innerHTML+=`
      <input type="checkbox" id="${c}" name="">
      <label for="${c}" style="color:${l[n]}">Community n°${n+1}</label>    
    `,a.append(i);const d=a.querySelector(`#${c}`);let m=null;const L=()=>{m?(m(),m=null):m=y(`community-${n}`,s,b(e.filterNodes((M,v)=>v.community===n),{radius:150,border:{color:l[n],thickness:8},levels:[{color:"#00000000",threshold:.5}]}))};d.addEventListener("change",L),o||(d.checked=!0,L())}),()=>{s==null||s.kill()}},w=`import { bindWebGLLayer, createContoursProgram } from "@sigma/layer-webgl";
...
`,j={id:"@sigma/layer-webgl",title:"Satellite packages/@sigma--layer-webgl"},q={name:"Metaballs",render:()=>f,play:g(G),args:{},parameters:{storySource:{source:A}}},z={name:"Highlight groups of nodes",render:()=>f,play:g(S),args:{},parameters:{storySource:{source:w}}},F={name:"Multiple levels",render:()=>f,play:g($),args:{},parameters:{storySource:{source:N}}};export{z as ContourLine,j as default,q as metaballs,F as plainContourLine};
