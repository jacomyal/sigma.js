...
`,z={id:"mouse-manipulations",title:"Core library/Advanced use cases"},P={name:"Node drag'n'drop, with mouse graph creation",render:()=>U,play:f(A),args:{},parameters:{storySource:{source:B}}};export{z as default,P as story};
