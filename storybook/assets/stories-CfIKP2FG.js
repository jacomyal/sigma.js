import{G as d,S as m,o as c}from"./utils-Ph0PoCvK.js";import{p as u}from"./index-CvkDsaGQ.js";import"./_commonjsHelpers-BosuxZz1.js";import"./is-graph-constructor-C6mKuIz0.js";import"./add-edge-CCsz5v3R.js";const g=()=>{let n=null;fetch("./arctic.gexf").then(e=>e.text()).then(e=>{const a=u(d,e),i=document.getElementById("sigma-container"),r=document.getElementById("zoom-in"),l=document.getElementById("zoom-out"),s=document.getElementById("zoom-reset"),t=document.getElementById("labels-threshold");n=new m(a,i,{minCameraRatio:.1,maxCameraRatio:10});const o=n.getCamera();r.addEventListener("click",()=>{o.animatedZoom({duration:600})}),l.addEventListener("click",()=>{o.animatedUnzoom({duration:600})}),s.addEventListener("click",()=>{o.animatedReset({duration:600})}),t.addEventListener("input",()=>{n==null||n.setSetting("labelRenderedSizeThreshold",+t.value)}),t.value=n.getSetting("labelRenderedSizeThreshold")+""}),c(()=>{n==null||n.kill()})},p=`<style>
  body {
...
`,E={id:"load-gexf-file",title:"Examples"},B={name:"Load GEXF file",render:()=>p,play:g,args:{},parameters:{storySource:{source:h}}};export{E as default,B as story};
