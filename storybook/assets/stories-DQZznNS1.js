import{g as n}from"./factory-Bf6xFtju.js";import{G as t,S as g,o as c,d as w,j as z}from"./utils-Ph0PoCvK.js";import{c as E}from"./chroma-CKzHTTCE.js";import"./_commonjsHelpers-BosuxZz1.js";const b=n(),u=n({keepWithinCircle:!1,size:{mode:"force",value:256},drawingMode:"color",correctCentering:!0}),m=`<style>
  html,
  body,
  #storybook-root,
  #sigma-container {
...
`,H={id:"node-image",title:"node-image"},T={name:"NodeImageRenderer",render:()=>m,play:I,args:{},parameters:{storySource:{source:S}}},V={name:"NodePictogramRenderer",render:()=>m,play:R,args:{},parameters:{storySource:{source:M}}},W={name:"NodePictogramRenderer with background colors",render:()=>m,play:B,args:{},parameters:{storySource:{source:_}}},U={name:"Displaying local images",render:()=>m,play:v,args:{},parameters:{storySource:{source:P}}},Y={name:"Options showcase",render:()=>m,play:G,args:{},parameters:{storySource:{source:D}}};export{H as default,U as localImages,T as nodeImages,V as nodePictograms,W as nodePictogramsWithBackground,Y as optionsShowcase};
