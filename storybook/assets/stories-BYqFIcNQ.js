import{G as h,S as p,w as g}from"./sigma-CUkpdr6a.js";import{l as x}from"./index-_Co8T1pk.js";import{i as C}from"./index-BwE_J3AR.js";import{d as k}from"./data-Bz6iBPrE.js";import{b as y,c as b}from"./index-CEgMv1NH.js";import{b as E}from"./index-B7jpjt43.js";import"./_commonjsHelpers-BosuxZz1.js";import"./getters-sgVfsx1C.js";import"./infer-type-Coab1osT.js";import"./is-graph-constructor-BVugt_gr.js";import"./add-edge-DJG1E9TZ.js";const w=()=>{const e=new h;e.import(k),x.assign(e,{nodeCommunityAttribute:"community"});const r=new Set;e.forEachNode((n,o)=>r.add(o.community));const t=Array.from(r),l=C(r.size).reduce((n,o,c)=>({...n,[t[c]]:o}),{});e.forEachNode((n,o)=>e.setNodeAttribute(n,"color",l[o.community]));const u=document.getElementById("sigma-container"),s=new p(e,u),a=document.createElement("div");return a.style.position="absolute",a.style.right="10px",a.style.bottom="10px",document.body.append(a),t.forEach((n,o)=>{const c=`cb-${n}`,i=document.createElement("div");i.innerHTML+=`
...
`,q={id:"@sigma/layer-webgl",title:"Satellite packages/@sigma--layer-webgl"},z={name:"Metaballs",render:()=>f,play:g(G),args:{},parameters:{storySource:{source:A}}},F={name:"Highlight groups of nodes",render:()=>f,play:g(w),args:{},parameters:{storySource:{source:S}}},X={name:"Multiple levels",render:()=>f,play:g($),args:{},parameters:{storySource:{source:N}}};export{F as ContourLine,q as default,z as metaballs,X as plainContourLine};
