import{G as j,S as J,o as K}from"./utils-Bhbjx1g-.js";import{i as Q}from"./is-graph-constructor-C6mKuIz0.js";import{a as tt}from"./add-edge-CCsz5v3R.js";import"./_commonjsHelpers-BosuxZz1.js";var x={},et=/^\s$/,it=/\s*,\s*/,rt=/\s*\|\s*/;function nt(t){return et.test(t)}function O(t){var e,i,r,n,a=!1,h=!1,s=void 0,f=[],g="";for(r=0,n=t.length;r<n;r++)if(e=t[r],a){if(s===void 0&&(s=""),!g&&e===","){r--,a=!1;continue}if(!h&&e===g){a=!1;continue}if(e==="\\"){if(r+1<n&&(i=t[r+1],i==="r"||i==="t"||i==="n"||i==="\\")){i==="n"?s+=`
