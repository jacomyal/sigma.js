import{G as b,S as x,w}from"./sigma-OLFhweM6.js";import{c as u}from"./chroma-CrraTPB2.js";import{F as f}from"./worker-BwrDVMt1.js";import"./_commonjsHelpers-BosuxZz1.js";import"./getters-Dzi6BvTr.js";let c;const N=new Uint8Array(16);function q(){if(!c&&(c=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!c))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return c(N)}const a=[];for(let t=0;t<256;++t)a.push((t+256).toString(16).slice(1));function S(t,e=0){return a[t[e+0]]+a[t[e+1]]+a[t[e+2]]+a[t[e+3]]+"-"+a[t[e+4]]+a[t[e+5]]+"-"+a[t[e+6]]+a[t[e+7]]+"-"+a[t[e+8]]+a[t[e+9]]+"-"+a[t[e+10]]+a[t[e+11]]+a[t[e+12]]+a[t[e+13]]+a[t[e+14]]+a[t[e+15]]}const D=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),p={randomUUID:D};function I(t,e,h){if(p.randomUUID&&!e&&!t)return p.randomUUID();t=t||{};const n=t.random||(t.rng||q)();return n[6]=n[6]&15|64,n[8]=n[8]&63|128,S(n)}const M=()=>{const t=document.getElementById("sigma-container"),e=new b;e.addNode("n1",{x:0,y:0,size:10,color:u.random().hex()}),e.addNode("n2",{x:-5,y:5,size:10,color:u.random().hex()}),e.addNode("n3",{x:5,y:5,size:10,color:u.random().hex()}),e.addNode("n4",{x:0,y:10,size:10,color:u.random().hex()}),e.addEdge("n1","n2"),e.addEdge("n2","n4"),e.addEdge("n4","n3"),e.addEdge("n3","n1"),new f(e,{isNodeFixed:(o,s)=>s.highlighted}).start();const n=new x(e,t);let i=null,l=!1;return n.on("downNode",o=>{l=!0,i=o.node,e.setNodeAttribute(i,"highlighted",!0)}),n.getMouseCaptor().on("mousemovebody",o=>{if(!l||!i)return;const s=n.viewportToGraph(o);e.setNodeAttribute(i,"x",s.x),e.setNodeAttribute(i,"y",s.y),o.preventSigmaDefault(),o.original.preventDefault(),o.original.stopPropagation()}),n.getMouseCaptor().on("mouseup",()=>{i&&e.removeNodeAttribute(i,"highlighted"),l=!1,i=null}),n.getMouseCaptor().on("mousedown",()=>{n.getCustomBBox()||n.setCustomBBox(n.getBBox())}),n.on("clickStage",({event:o})=>{const m={...n.viewportToGraph({x:o.x,y:o.y}),size:10,color:u.random().hex()},v=e.nodes().map(r=>{const d=e.getNodeAttributes(r),y=Math.pow(m.x-d.x,2)+Math.pow(m.y-d.y,2);return{nodeId:r,distance:y}}).sort((r,d)=>r.distance-d.distance).slice(0,2),g=I();e.addNode(g,m),v.forEach(r=>e.addEdge(g,r.nodeId))}),()=>{n.kill()}},A=`<style>
  html,
  body {
...
`,C=`import chroma from "chroma-js";
...
`,k={id:"mouse-manipulations",title:"Core library/Advanced use cases"},z={name:"Node drag'n'drop, with mouse graph creation",render:()=>A,play:w(M),args:{},parameters:{storySource:{source:C}}};export{k as default,z as story};
