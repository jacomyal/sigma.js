...
`,z={id:"camera-control",title:"Core library/Features showcases"},P={name:"Camera control",render:()=>R,play:x(L),args:{},parameters:{storySource:{source:k}}};export{z as default,P as story};
