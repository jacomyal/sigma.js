import{r as P,G as O,S as G,b as C,w as q}from"./sigma-CUkpdr6a.js";import{r as D,F as _}from"./worker-mFIzwX63.js";import{r as H}from"./circular-BMfGPNjs.js";import{r as T}from"./getters-sgVfsx1C.js";import{f as U}from"./index-DE-rwKI7.js";import{d as j}from"./data-Bz6iBPrE.js";import"./_commonjsHelpers-BosuxZz1.js";var A={},B,k;function Y(){if(k)return B;k=1;var r=T(),E=P(),L={dimensions:["x","y"],center:.5,rng:Math.random,scale:1};function h(v,y,o){if(!E(y))throw new Error("graphology-layout/random: the given graph is not a valid graphology instance.");o=r(o,L);var a=o.dimensions;if(!Array.isArray(a)||a.length<1)throw new Error("graphology-layout/random: given dimensions are invalid.");var e=a.length,i=o.center,u=o.rng,c=o.scale,f=(i-.5)*c;function m(t){for(var n=0;n<e;n++)t[a[n]]=u()*c+f;return t}if(!v){var p={};return y.forEachNode(function(t){p[t]=m({})}),p}y.updateEachNodeAttributes(function(t,n){return m(n),n},{attributes:a})}var g=h.bind(null,!1);return g.assign=h.bind(null,!0),B=g,B}var S,N;function Z(){if(N)return S;N=1;var r=T(),E=P(),L=Math.PI/180,h={dimensions:["x","y"],centeredOnZero:!1,degrees:!1};function g(y,o,a,e){if(!E(o))throw new Error("graphology-layout/rotation: the given graph is not a valid graphology instance.");e=r(e,h),e.degrees&&(a*=L);var i=e.dimensions;if(!Array.isArray(i)||i.length!==2)throw new Error("graphology-layout/random: given dimensions are invalid.");if(o.order===0)return y?void 0:{};var u=i[0],c=i[1],f=0,m=0;if(!e.centeredOnZero){var p=1/0,t=-1/0,n=1/0,x=-1/0;o.forEachNode(function(d,s){var l=s[u],F=s[c];l<p&&(p=l),l>t&&(t=l),F<n&&(n=F),F>x&&(x=F)}),f=(p+t)/2,m=(n+x)/2}var w=Math.cos(a),b=Math.sin(a);function I(d){var s=d[u],l=d[c];return d[u]=f+(s-f)*w-(l-m)*b,d[c]=m+(s-f)*b+(l-m)*w,d}if(!y){var R={};return o.forEachNode(function(d,s){var l={};l[u]=s[u],l[c]=s[c],R[d]=I(l)}),R}o.updateEachNodeAttributes(function(d,s){return I(s),s},{attributes:i})}var v=g.bind(null,!1);return v.assign=g.bind(null,!0),S=v,S}var M;function z(){return M||(M=1,A.circlepack=D(),A.circular=H(),A.random=Y(),A.rotation=Z()),A}var V=z();const J=()=>{const r=new O;r.import(j);const E=document.getElementById("sigma-container"),L=document.getElementById("forceatlas2"),h=document.getElementById("forceatlas2-stop-label"),g=document.getElementById("forceatlas2-start-label"),v=document.getElementById("random"),y=document.getElementById("circular"),o=U.inferSettings(r),a=new _(r,{settings:o});let e=null;function i(){a.stop(),g.style.display="flex",h.style.display="none"}function u(){e&&e(),a.start(),g.style.display="none",h.style.display="flex"}function c(){a.isRunning()?i():u()}L.addEventListener("click",c);function f(){a.isRunning()&&i(),e&&e();const t={min:0,max:0},n={min:0,max:0};r.forEachNode((w,b)=>{t.min=Math.min(b.x,t.min),t.max=Math.max(b.x,t.max),n.min=Math.min(b.y,n.min),n.max=Math.max(b.y,n.max)});const x={};r.forEachNode(w=>{x[w]={x:Math.random()*(t.max-t.min),y:Math.random()*(n.max-n.min)}}),e=C(r,x,{duration:2e3})}v.addEventListener("click",f);function m(){a.isRunning()&&i(),e&&e();const t=V.circular(r,{scale:100});e=C(r,t,{duration:2e3,easing:"linear"})}y.addEventListener("click",m);const p=new G(r,E);return()=>{p.kill()}},K=`<style>
  html,
  body,
  #storybook-root,
  #sigma-container {
...
`,ot={id:"layouts",title:"Core library/Features showcases"},rt={name:"Layouts example",render:()=>K,play:q(J),args:{},parameters:{storySource:{source:Q}}};export{ot as default,rt as story};
