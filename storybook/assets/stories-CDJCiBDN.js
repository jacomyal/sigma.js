var ze=Object.defineProperty;var pe=(t,e,r)=>e in t?ze(t,e,{enumerable:!0,configurable:!0,writable:!0,value:r}):t[e]=r;var re=(t,e,r)=>pe(t,typeof e!="symbol"?e+"":e,r);import{l as V,E as oe,m as ke,f as ne,o as he,p as ae,M as $,S as L,q as me,r as X,G as ue,w as P}from"./sigma-Pld0JHRn.js";import"./_commonjsHelpers-BosuxZz1.js";const fe=`
attribute vec4 a_id;
...
`,Qe={id:"@sigma/edge-curve",title:"Satellite packages/@sigma--edge-curve"},Ze={name:"Basic example",render:()=>N,play:P(Ge),args:{},parameters:{storySource:{source:Fe}}},He={name:"Interactions",render:()=>N,play:P(Oe),args:{},parameters:{storySource:{source:Ue}}},et={name:"Labels",render:()=>N,play:P(Ve),args:{},parameters:{storySource:{source:$e}}},tt={name:"Parallel edges",render:()=>N,play:P(Xe),args:{},parameters:{storySource:{source:Ye}}},rt={name:"Arrow heads",render:()=>N,play:P(Ne),args:{},parameters:{storySource:{source:De}}};export{rt as arrowHeads,Ze as basic,Qe as default,He as interactions,et as labels,tt as parallelEdges};
