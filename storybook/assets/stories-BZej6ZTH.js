var B=Object.defineProperty;var $=(n,e,d)=>e in n?B(n,e,{enumerable:!0,configurable:!0,writable:!0,value:d}):n[e]=d;var g=(n,e,d)=>($(n,typeof e!="symbol"?e+"":e,d),d);import{N as P,f as D,d as R,G as p,S as m,o as u,c as T}from"./utils-C5QP6GGe.js";import{g as A}from"./factory-fWm_FWXa.js";import"./_commonjsHelpers-BosuxZz1.js";const z=`<style>
  html,
  body,
  #storybook-root,
  #sigma-container {
...
`,M="relative",k={borders:[{size:{value:.1},color:{attribute:"borderColor"}},{size:{fill:!0},color:{attribute:"color"}}]},I="#000000";function h(n){return n%1===0?n.toFixed(1):n.toString()}function G({borders:n}){const e=h(n.filter(({size:r})=>"fill"in r).length);return`
