import{i as E,G as S,S as B,o as I,a as A}from"./utils-Ph0PoCvK.js";import{F as N}from"./circlepack-DZXhA5x8.js";import{c as C}from"./circular-DjQztPqt.js";import{d as L}from"./defaults-9mJNxk8k.js";import{f as M}from"./index-BLxkOZoo.js";import{d as P}from"./data-ro0eVT-D.js";import"./_commonjsHelpers-BosuxZz1.js";var k=L,T=E,R={dimensions:["x","y"],center:.5,rng:Math.random,scale:1};function w(e,c,r){if(!T(c))throw new Error("graphology-layout/random: the given graph is not a valid graphology instance.");r=k(r,R);var a=r.dimensions;if(!Array.isArray(a)||a.length<1)throw new Error("graphology-layout/random: given dimensions are invalid.");var d=a.length,y=r.center,f=r.rng,p=r.scale,s=(y-.5)*p;function n(m){for(var l=0;l<d;l++)m[a[l]]=f()*p+s;return m}if(!e){var g={};return c.forEachNode(function(m){g[m]=n({})}),g}c.updateEachNodeAttributes(function(m,l){return n(l),l},{attributes:a})}var O=w.bind(null,!1);O.assign=w.bind(null,!0);var D=L,G=E,H=Math.PI/180,U={dimensions:["x","y"],centeredOnZero:!1,degrees:!1};function F(e,c,r,a){if(!G(c))throw new Error("graphology-layout/rotation: the given graph is not a valid graphology instance.");a=D(a,U),a.degrees&&(r*=H);var d=a.dimensions;if(!Array.isArray(d)||d.length!==2)throw new Error("graphology-layout/random: given dimensions are invalid.");if(c.order===0)return e?void 0:{};var y=d[0],f=d[1],p=0,s=0;if(!a.centeredOnZero){var n=1/0,g=-1/0,m=1/0,l=-1/0;c.forEachNode(function(t,o){var i=o[y],h=o[f];i<n&&(n=i),i>g&&(g=i),h<m&&(m=h),h>l&&(l=h)}),p=(n+g)/2,s=(m+l)/2}var b=Math.cos(r),x=Math.sin(r);function v(t){var o=t[y],i=t[f];return t[y]=p+(o-p)*b-(i-s)*x,t[f]=s+(o-p)*x+(i-s)*b,t}if(!e){var u={};return c.forEachNode(function(t,o){var i={};i[y]=o[y],i[f]=o[f],u[t]=v(i)}),u}c.updateEachNodeAttributes(function(t,o){return v(o),o},{attributes:d})}var _=F.bind(null,!1);_.assign=F.bind(null,!0);var j=C;const $=()=>{const e=new S;e.import(P);const c=document.getElementById("sigma-container"),r=document.getElementById("forceatlas2"),a=document.getElementById("forceatlas2-stop-label"),d=document.getElementById("forceatlas2-start-label"),y=document.getElementById("random"),f=document.getElementById("circular"),p=M.inferSettings(e),s=new N(e,{settings:p});let n=null;function g(){s.stop(),d.style.display="flex",a.style.display="none"}function m(){n&&n(),s.start(),d.style.display="none",a.style.display="flex"}function l(){s.isRunning()?g():m()}r.addEventListener("click",l);function b(){s.isRunning()&&g(),n&&n();const u={min:0,max:0},t={min:0,max:0};e.forEachNode((i,h)=>{u.min=Math.min(h.x,u.min),u.max=Math.max(h.x,u.max),t.min=Math.min(h.y,t.min),t.max=Math.max(h.y,t.max)});const o={};e.forEachNode(i=>{o[i]={x:Math.random()*(u.max-u.min),y:Math.random()*(t.max-t.min)}}),n=A(e,o,{duration:2e3})}y.addEventListener("click",b);function x(){s.isRunning()&&g(),n&&n();const u=j(e,{scale:100});n=A(e,u,{duration:2e3,easing:"linear"})}f.addEventListener("click",x);const v=new B(e,c);I(()=>{v.kill()})},Y=`<style>
  html,
  body,
  #storybook-root,
  #sigma-container {
...
`,X={id:"layouts",title:"Examples"},tt={name:"Layouts example",render:()=>Y,play:$,args:{},parameters:{storySource:{source:Z}}};export{X as default,tt as story};
