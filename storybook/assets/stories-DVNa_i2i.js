import{G as p,S as m,w as f}from"./sigma-D6zuMBvc.js";import{d as v}from"./data-ro0eVT-D.js";import"./_commonjsHelpers-BosuxZz1.js";const y=()=>{const c=document.getElementById("sigma-container"),i=document.getElementById("search-input"),u=document.getElementById("suggestions"),s=new p;s.import(v);const r=new m(s,c),e={searchQuery:""};u.innerHTML=s.nodes().map(n=>`<option value="${s.getNodeAttribute(n,"label")}"></option>`).join(`
