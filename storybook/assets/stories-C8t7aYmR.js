...
`,E={id:"use-reducers",title:"Core library/Features showcases"},x={name:"Use node and edge reducers",render:()=>N,play:f(y),args:{},parameters:{storySource:{source:b}}};export{E as default,x as story};
