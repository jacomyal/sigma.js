var I=Object.defineProperty;var V=(o,e,t)=>e in o?I(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var u=(o,e,t)=>(V(o,typeof e!="symbol"?e+"":e,t),t);import{N as B,f as F,d as y,G as m,S as h,o as v,D as G}from"./utils-C5QP6GGe.js";import"./_commonjsHelpers-BosuxZz1.js";const _="#000000",w={defaultColor:_,offset:{value:0}};function j(o){return o%1===0?o.toFixed(1):o.toString()}function U({slices:o,offset:e}){return`
...
`)}
  ...
  // Sizes:
${o.map(({value:n},a)=>`  float sliceValue_${a+1} = ${"attribute"in n?`v_sliceValue_${a+1}`:j(n.value)};`).join(`
`)}
...
`}function H({slices:o,offset:e}){return`
attribute vec4 a_id;
