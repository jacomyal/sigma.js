import{G as b,S as N,w as f}from"./sigma-Pld0JHRn.js";import{c as u}from"./chroma-CrraTPB2.js";import{F as w}from"./worker-CT4DGIFR.js";import"./_commonjsHelpers-BosuxZz1.js";import"./getters-Dzi6BvTr.js";let c;const q=new Uint8Array(16);function S(){if(!c&&(c=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!c))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return c(q)}const a=[];for(let t=0;t<256;++t)a.push((t+256).toString(16).slice(1));function D(t,e=0){return a[t[e+0]]+a[t[e+1]]+a[t[e+2]]+a[t[e+3]]+"-"+a[t[e+4]]+a[t[e+5]]+"-"+a[t[e+6]]+a[t[e+7]]+"-"+a[t[e+8]]+a[t[e+9]]+"-"+a[t[e+10]]+a[t[e+11]]+a[t[e+12]]+a[t[e+13]]+a[t[e+14]]+a[t[e+15]]}const I=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),h={randomUUID:I};function A(t,e,v){if(h.randomUUID&&!e&&!t)return h.randomUUID();t=t||{};const n=t.random||(t.rng||S)();return n[6]=n[6]&15|64,n[8]=n[8]&63|128,D(n)}const E=()=>{const t=document.getElementById("sigma-container"),e=new b;e.addNode("n1",{x:0,y:0,size:10,color:u.random().hex()}),e.addNode("n2",{x:-5,y:5,size:10,color:u.random().hex()}),e.addNode("n3",{x:5,y:5,size:10,color:u.random().hex()}),e.addNode("n4",{x:0,y:10,size:10,color:u.random().hex()}),e.addEdge("n1","n2"),e.addEdge("n2","n4"),e.addEdge("n4","n3"),e.addEdge("n3","n1"),new w(e,{isNodeFixed:(i,s)=>s.highlighted}).start();const n=new N(e,t,{minCameraRatio:.5,maxCameraRatio:2});let o=null,l=!1;n.on("downNode",i=>{l=!0,o=i.node,e.setNodeAttribute(o,"highlighted",!0),n.getCustomBBox()||n.setCustomBBox(n.getBBox())}),n.on("moveBody",({event:i})=>{if(!l||!o)return;const s=n.viewportToGraph(i);e.setNodeAttribute(o,"x",s.x),e.setNodeAttribute(o,"y",s.y),i.preventSigmaDefault(),i.original.preventDefault(),i.original.stopPropagation()});const g=()=>{o&&e.removeNodeAttribute(o,"highlighted"),l=!1,o=null};return n.on("upNode",g),n.on("upStage",g),n.on("clickStage",({event:i})=>{const m={...n.viewportToGraph({x:i.x,y:i.y}),size:10,color:u.random().hex()},y=e.nodes().map(r=>{const d=e.getNodeAttributes(r),x=Math.pow(m.x-d.x,2)+Math.pow(m.y-d.y,2);return{nodeId:r,distance:x}}).sort((r,d)=>r.distance-d.distance).slice(0,2),p=A();e.addNode(p,m),y.forEach(r=>e.addEdge(p,r.nodeId))}),()=>{n.kill()}},U=`<style>
  html,
  body {
...
`,z={id:"mouse-manipulations",title:"Core library/Advanced use cases"},P={name:"Node drag'n'drop, with mouse graph creation",render:()=>U,play:f(E),args:{},parameters:{storySource:{source:B}}};export{z as default,P as story};
