...
const state = {
  order: +(document.querySelector<HTMLInputElement>("#order") as HTMLInputElement).value,
  size: +(document.querySelector<HTMLInputElement>("#size") as HTMLInputElement).value,
  clusters: +(document.querySelector<HTMLInputElement>("#clusters") as HTMLInputElement).value,
  edgesRenderer: (document.querySelector<HTMLInputElement>('[name="edges-renderer"]:checked') as HTMLInputElement)
    .value,
};
