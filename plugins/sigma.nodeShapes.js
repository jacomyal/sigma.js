...
sigma.nodeShapes.NodeShapes = function(graph) {
  ...
  this.init = function() {
	...
	this.originalFunctions['drawNodeShape'] 		= Plotter.prototype.drawNodeShape;
	this.originalFunctions['drawHoverNodeBorder'] 	= Plotter.prototype.drawHoverNodeBorder;
	this.originalFunctions['drawHoverNodeShape'] 	= Plotter.prototype.drawHoverNodeShape;
	this.originalFunctions['drawActiveNodeBorder'] 	= Plotter.prototype.drawActiveNodeBorder;
	this.originalFunctions['drawActiveNodeShape'] 	= Plotter.prototype.drawActiveNodeShape;
  ...
  this.finalize = function() {
	...
	Plotter.prototype.drawNodeShape 		= this.originalFunctions['drawNodeShape'];
	Plotter.prototype.drawHoverNodeBorder 	= this.originalFunctions['drawHoverNodeBorder'];
	Plotter.prototype.drawHoverNodeShape 	= this.originalFunctions['drawHoverNodeShape'];
	Plotter.prototype.drawActiveNodeBorder 	= this.originalFunctions['drawActiveNodeBorder'];
	Plotter.prototype.drawActiveNodeShape 	= this.originalFunctions['drawActiveNodeShape'];
  };
