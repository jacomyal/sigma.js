import getPointsOnQuadraticCurve from "../../utils/geometry/getPointOnQuadraticCurve";
 ...
 * @return {object} A square: two points (x1, y1), (x2, y2) and height.
 */
export function lineToSquare(e) {
  if (e.y1 < e.y2) {
    // (e.x1, e.y1) on top
    if (e.x1 < e.x2) {
      // (e.x1, e.y1) on left
 ...
 * @return {object}    A square: two points (x1, y1), (x2, y2) and height.
 */
export function quadraticCurveToSquare(e, cp) {
  const pt = getPointsOnQuadraticCurve(0.5, e.x1, e.y1, e.x2, e.y2, cp.x, cp.y);
 ...
 * @return {object}   A square: two points (x1, y1), (x2, y2) and height.
 */
export function selfLoopToSquare(n) {
